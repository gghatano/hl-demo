...
# the reason we use a var here is considering with org5 specific folder
# when invoking this for org5 as test-network/scripts/org5-scripts
...
signConfigtxAsPeerOrg 2 ${TEST_NETWORK_HOME}/channel-artifacts/org5_update_in_envelope.pb
infoln "Additional signing by Org3 for MAJORITY policy"
signConfigtxAsPeerOrg 3 ${TEST_NETWORK_HOME}/channel-artifacts/org5_update_in_envelope.pb
infoln "Additional signing by Org4 for MAJORITY policy"
signConfigtxAsPeerOrg 4 ${TEST_NETWORK_HOME}/channel-artifacts/org5_update_in_envelope.pb
